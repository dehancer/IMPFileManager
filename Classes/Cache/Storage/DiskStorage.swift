...
public enum DiskStorage {
    ...
    public class Backend<T: DataTransformable> {
        ...
        public init(config: Config = Config()) throws {
            ...
            metaChangingQueue = DispatchQueue(label: self.config.name)
        ...
        func prepareDirectory() throws {
            ...
            do {
                ...
                throw DehancerError.cacheError(reason: .cannotCreateDirectory(path: path, error: error))
            }
        }
            ...
            expiration: StorageExpiration? = nil) throws
        {
            ...
            do {
                ...
                throw DehancerError.cacheError(reason: .cannotConvertToData(object: value, error: error))
            }
        ...
        func value(forKey key: String, referenceDate: Date, actuallyLoad: Bool) throws -> T? {
            ...
            do {
                ...
                throw DehancerError.cacheError(
            ...
            do {
                ...
                throw DehancerError.cacheError(reason: .cannotLoadDataFromDisk(url: fileURL, error: error))
            }
        }
        ...
        func allFileURLs(for propertyKeys: [URLResourceKey]) throws -> [URL] {
            ...
            {
                throw DehancerError.cacheError(reason: .fileEnumeratorCreationFailed(url: directoryURL))
            }
            
            guard let urls = directoryEnumerator.allObjects as? [URL] else {
                throw DehancerError.cacheError(reason: .invalidFileEnumeratorContent(url: directoryURL))
            }
            return urls
        }
